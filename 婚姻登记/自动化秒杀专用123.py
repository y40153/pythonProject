...
def run():
    ...
    if shijisj >= mubiaosj:
        jishiqi.cancel()
        print('时机已到')
        data = seckill('2023-12-03', '10:00-11:00', '440304', '深圳市福田区民政局婚姻登记处',
                       '赖钲予', '420983199804059550', '13760171751',
                       '王美霁', '440301199801044421', '13544242954',
                       34)
        while True:
        ...
        # seckill('2023-12-01', '14:00-14:30', '440304', '深圳市福田区民政局婚姻登记处',
