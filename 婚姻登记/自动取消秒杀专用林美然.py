        ...
        try:
            ...
            for d in data:
                ...
                if d['syl'] > 0:  # 秒杀准备，有号判断
                    ...
                    payloadq = f'ids=21f4aa0d92ec40ba8dea28cb6b8964cc:1:d35ef9398e75462da7287ba8b0e92631'
...
def chaxun():
    ...
    while True:
        ...
        print(f'林美然{sj},第{zi}次轮询：有{key}个区有号')
        zi += 1
...
def run(yyrq, shij, bianhao, diz):
    seckill2(f'{yyrq}', f'{shij}', f'{bianhao}', f'{diz}',
             'NG KAR KEN', 'A55228122', '15279101998',
             '林美然', '440803199002073429', '18823843273',
             32)
