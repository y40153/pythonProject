...
def run():
    ...
    if shijisj >= mubiaosj:
        jishiqi.cancel()
        print('时机已到')
        data = seckill('2022-12-01', '9:00-10:00', '440304', '深圳市福田区民政局婚姻登记处',
                       '刘启豪', '441621199812016736', '13028823772',
                       '徐淑贤', '441381200012013225', '13802284660',
                       34)
        while True:
        ...
        seckill('2022-12-01', '14:00-14:30', '440304', '深圳市福田区民政局婚姻登记处',
                '仇振宇', '440306199306091310', '13631530430',
                '廖彤', '440306199108312821', '13751059022',
                34)
        seckill('2022-12-01', '14:00-14:30', '440304', '深圳市福田区民政局婚姻登记处',
                '辛锴', '440508199806054616', '17324089646',
                '洪迪楠', '445121199808234825', '13688919897',
                34)
