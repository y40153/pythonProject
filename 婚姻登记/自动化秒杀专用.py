...
def run():
    ...
    if shijisj >= mubiaosj:
        jishiqi.cancel()
        print('时机已到')
        data = seckill('2022-11-01', '10:00-11:00', '440304', '深圳市福田区民政局婚姻登记处',
                       '祁鑫鑫', '320621199704081217', '13951381388',
                       '韩天瀛', '44030119971014542X', '13544169190',
                       34)
        while True:
            ...
            if re.search('剩余号源不够', data) is None:
                ...
                data = seckill('2022-11-01', '10:00-11:00', '440304', '深圳市福田区民政局婚姻登记处',
                               ...
                               '韩天瀛', '44030119971014542X', '13544169190',
                               34)
        seckill('2022-11-01', '14:30-15:30', '440304', '深圳市福田区民政局婚姻登记处',
                '刘科铄', '441481199601211131', '13502802933',
                '蔡宜潼', '441900199508034862', '13412922280',
                34)
        seckill('2022-11-01', '14:00-14:30', '440304', '深圳市福田区民政局婚姻登记处',
                '郑浩嵘', '441900199609137553', '13530452295',
                '郭帆', '360734199505220047', '15118042543',
                34)
        seckill('2022-11-01', '15:30-16:30', '440304', '深圳市福田区民政局婚姻登记处',
                '陈灏', '440301199110177815', '13612955830',
                '李慧莹', '440301199111195425', '13691922881',
                34)
        sendmail(data)
