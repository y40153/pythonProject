...
def run():
    ...
    if shijisj >= mubiaosj:
        jishiqi.cancel()
        print('时机已到')
        data = seckill('2022-10-21', '10:00-11:00', '440304', '深圳市福田区民政局婚姻登记处',
                       '林航', '440582199504106314', '18823662866',
                       '郭婉婷', '440582199503180088', '15012698329',
                       34)
        while True:
            ...
            if re.search('剩余号源不够', data) is None:
                ...
                data = seckill('2022-10-21', '10:00-11:00', '440304', '深圳市福田区民政局婚姻登记处',
                               ...
                               '郭婉婷', '440582199503180088', '15012698329',
                               34)
        # seckill('2022-10-20', '9:00-10:00', '440304', '深圳市福田区民政局婚姻登记处',
        #         '李嘉裕', '441424199512180532', '13560467686',
        #         '林停恩', '440582199507300622', '15602242096',
        #         34)
        # seckill('2022-10-20', '14:30-15:30', '440304', '深圳市福田区民政局婚姻登记处',
        #         '殷沛林', '441900199402286754', '13316980660',
        #         '聂潇', '370104199003212224', '13510806290',
        #         34)
        # seckill('2022-10-20', '10:00-11:00', '440304', '深圳市福田区民政局婚姻登记处',
        #         '张耕源', '370306199708301511', '15989861173',
        #         '利杰', '440301199304215525', '18210107741',
        #         34)
