...
def run():
    ...
    if shijisj >= mubiaosj:
        jishiqi.cancel()
        print('时机已到')
        data = seckill('2022-11-07', '10:00-11:00', '440304', '深圳市福田区民政局婚姻登记处',
                       '张若晨', '310107199511083914', '18145802112',
                       '卞瑞瑶', '340403199502011421', '18918804799',
                       34)
        while True:
            ...
            if re.search('剩余号源不够', data) is None:
                ...
                data = seckill('2022-11-07', '10:00-11:00', '440304', '深圳市福田区民政局婚姻登记处',
                               ...
                               '卞瑞瑶', '340403199502011421', '18918804799',
                               34)
        seckill('2022-11-07', '14:30-15:30', '440304', '深圳市福田区民政局婚姻登记处',
