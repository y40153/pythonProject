...
def run():
    ...
    if shijisj >= mubiaosj:
        jishiqi.cancel()
        print('时机已到')
        data = seckill('2022-10-01', '10:00-11:00', '440304', '深圳市福田区民政局婚姻登记处',
                       '林崇豪', '440582199412023933', '18814383709',
                       '朱晋毅', '44030319950303202X', '13823195413',
                       34)
        while True:
        ...
        # data = seckill('2022-09-27', '14:00-14:30', '440304', '深圳市福田区民政局婚姻登记处',
