...
def run():
    ...
    if shijisj >= mubiaosj:
        jishiqi.cancel()
        print('时机已到')
        data = seckill('2022-11-02', '14:00-14:30', '440304', '深圳市福田区民政局婚姻登记处',
                       '周洛恩', '440301199508163819', '13025479255',
                       '侯锡雯', '445222199507080043', '13510550394',
                       34)
        while True:
            ...
            if re.search('剩余号源不够', data) is None:
                ...
                data = seckill('2022-11-02', '14:00-14:30', '440304', '深圳市福田区民政局婚姻登记处',
                               ...
                               '侯锡雯', '445222199507080043', '13510550394',
                               34)
        seckill('2022-11-02', '14:30-15:30', '440304', '深圳市福田区民政局婚姻登记处',
                '邢强', '622421199407130010', '17512086299',
                '龙芳', '360311199503180102', '13017313561',
                34)
