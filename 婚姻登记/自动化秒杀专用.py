...
def run():
    ...
    if shijisj >= mubiaosj:
        jishiqi.cancel()
        print('时机已到')
        data = seckill('2022-10-08', '10:00-11:00', '440304', '深圳市福田区民政局婚姻登记处',
                       '熊彬宏', '500101199506180012', '15123313063',
                       '王倩倩', '420521199408010041', '16602130242',
                       34)
        while True:
        ...
        seckill('2022-10-08', '9:00-10:00', '440308', '深圳市盐田区民政局婚姻登记处',
                '赵朗博', '14031119910818003X', '18588491099',
                '张春萍', '440902199403304442', '13650434953',
                34)
        data = seckill('2022-10-08', '9:00-10:00', '440306', '深圳市宝安区民政局婚姻登记处',
                       '肖毅', '522633198702026417', '13702586417',
                       '王薇', '430521199009136888', '13603059425',
                       34)
        sendmail(data)
