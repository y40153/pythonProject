...
def run():
    ...
    mubiaosj = f'2022-{yyrq}' + ' 08:29:58'  # 秒杀时间
    print('-' * 30)
    ...
    if shijisj >= mubiaosj:
        jishiqi.cancel()
        print('时机已到')
        data = seckill('2022-10-10', '14:30-15:30', '440304', '深圳市福田区民政局婚姻登记处',
                       '陈良桥', '420881198710120012', '15820423018 ',
                       '卜子芸', '440301199210055620', '13927417690',
                       34)
        while True:
        ...
        seckill('2022-10-10', '9:00-10:00', '440304', '深圳市福田区民政局婚姻登记处',
                '唐诚', '340103199201013531', '13316980660',
                '聂潇', '370104199003212224', '13510806290',
                34)
        seckill('2022-10-10', '9:00-10:00', '440305', '深圳市南山区民政局婚姻登记处',
                '张楚东', '420621197711078010', '13713915701',
                '万玉萍', '452628197901300024', '18665353931',
                34)
        seckill('2022-10-10', '10:00-11:00', '440304', '深圳市福田区民政局婚姻登记处',
                '陈明', '44538119901021251X', '15989220848',
                '林锦溶', '441581199412053045', '13714499046',
                34)
        seckill('2022-10-10', '14:00-14:30', '440304', '深圳市福田区民政局婚姻登记处',
                '巨翔', '620102199201082714', '18680687757',
                '袁溢', '620121199105110526', '17793107266',
                34)
        seckill('2022-10-10', '14:00-14:30', '440304', '深圳市福田区民政局婚姻登记处',
                '宋清华', '350321199011037351', '13699791718',
                '胡沁盈', '440105199312051828', '13631234068',
                34)
        seckill('2022-10-10', '14:00-14:30', '440304', '深圳市福田区民政局婚姻登记处',
                '李勉', '440301199511304117', '13244720475',
                '翟健晖', '44030119970515556X', '13510883932',
                34)
        seckill('2022-10-10', '10:00-11:00', '440306', '深圳市宝安区民政局婚姻登记处',
                '周泽深', '445281199405124359', '13798383148',
                '刘文涛', '130281199303040042', '15279101998',
                34)
        seckill('2022-10-10', '10:00-11:00', '440304', '深圳市福田区民政局婚姻登记处',
                '罗立濠', '441423199703042750', '13410902489',
                '罗慧慧', '441402199412041043', '14718248074',
                34)
        seckill('2022-10-10', '14:30-15:30', '440305', '深圳市南山区民政局婚姻登记处',
                '王平', '532124199407290517', '15019440402',
                '方晓婷', '440682199504036024', '13709661777',
                34)
        sendmail(data)
