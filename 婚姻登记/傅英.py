...
def seckill(date, time, bianhao, dizhi, manname, manhao, phone, wumanname, wumanhao, phone2, colour):
    ...
    headers = {
        ...
        'x-ysshint': '24e308c4-7c75-e591-ac87-e018df4e4d211660702016256',
        'dgd-pre-release': '0',
...
def chaxun():
    ...
    while True:
        ...
        key = query(date, '440306','宝安区') + query(date, '440307',
                '龙岗区') + query(date, '440309', '龙华区')
