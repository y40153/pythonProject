...
def yzm(cancel):
    ...
    if cancel == None:
        ...
        if os.name == 'posix':
            ...
            with open('./证件信息2.txt', mode='w', encoding='utf‐8') as a_file:
                a_file.write(f'JSESSIONID={values};openstack_cookie_insert={values2}')
                # 写字
        else:
            with open(r'./证件信息2.txt', mode='w', encoding='utf‐8') as a_file:
                a_file.write(f'JSESSIONID={values};openstack_cookie_insert={values2}')
            # 写字
    return zhi
...
def run(yyrq, shij, bianhao, diz):
    seckill('2023-01-01', '9:00-10:00', '440304', '深圳市福田区民政局婚姻登记处',
            '傅坤栋', '441621199602085936', '15602956468',
            '江雪花', '441621199804182806', '13049471727',
            34)
    seckill('2023-01-01', '14:00-14:30', '440304', '深圳市福田区民政局婚姻登记处',
            '张泽智', '440508199212212314', '13760257096',
            '许曼婷', '440508199308262041', '13570315101',
            34)
    seckill('2023-01-01', '14:30-15:30', '440304', '深圳市福田区民政局婚姻登记处',
            '田仲一', '440301198802064411', '18665862560',
            '仲嫄', '411202199203161528', '13480211814',
            34)
    seckill('2023-01-01', '15:30-16:30', '440304', '深圳市福田区民政局婚姻登记处',
            '王淙术', '430725199307240356', '13682526598',
            '宋忆玲', '511002199406176845', '17380152510',
            34)
    seckill('2023-01-01', '14:30-15:30', '440304', '深圳市福田区民政局婚姻登记处',
            '石涛', '432503199809307015', '15084760811',
            '黄海宁', '431223200207146860', '18603060714',
            34)
    return
