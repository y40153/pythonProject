...
def run():
    ...
    if shijisj >= mubiaosj:
        jishiqi.cancel()
        print('时机已到')
        data = seckill('2022-09-15', '10:00-11:00', '440304', '深圳市福田区民政局婚姻登记处',
                       '林毓翔', '450203199510110715', '18819001638',
                       '钟幸均', '440307199510070222', '13798554318',
                       32, shijisj)
        while True:
            ...
            if re.search('剩余号源不够', data) is None:
                ...
                data = seckill('2022-09-15', '10:00-11:00', '440304', '深圳市福田区民政局婚姻登记处',
                               ...
                               '钟幸均', '440307199510070222', '13798554318',
                               32, shijisj)
        seckill('2022-09-15', '10:00-11:00', '440304', '深圳市福田区民政局婚姻登记处',
                '姒卫锜', '330602199502033017', '15700080512',
                '沙泽泓', '53042519950915172X', '17787919081',
                32, shijisj)
        input('输入任意字符退出程序')
