...
def run():
    ...
    if shijisj >= mubiaosj:
        jishiqi.cancel()
        print('时机已到')
        data = seckill('2022-09-19', '10:00-11:00', '440304', '深圳市福田区民政局婚姻登记处',
                       '陈佳杭', '441522199905254275', '15820479420',
                       '杨嘉恩', '440307199906271223', '13724209322',
                       32, shijisj)
        while True:
            ...
            if re.search('剩余号源不够', data) is None:
                ...
                data = seckill('2022-09-19', '10:00-11:00', '440304', '深圳市福田区民政局婚姻登记处',
                               ...
                               '杨嘉恩', '440307199906271223', '13724209322',
                               33, shijisj)
        seckill('2022-09-19', '11:00-11:30', '440304', '深圳市福田区民政局婚姻登记处',
                '黄家林', '445281199304162110', '13760218127',
                '钟佳敏', '440306199612250324', '13169641705',
                34, shijisj)
        seckill('2022-09-19', '10:00-11:00', '440304', '深圳市福田区民政局婚姻登记处',
                '洪政凯', '44030119920122551X', '13246728012',
                '黄树蓉', '440301199501104621', '15013610204',
                35, shijisj)
        seckill('2022-09-19', '14:30-15:30', '440304', '深圳市福田区民政局婚姻登记处',
                '洪明茂', '440882199012110698', '18825054231',
                '袁诗韵', '440882199410198621', '15002023838',
                36, shijisj)
        seckill('2022-09-19', '15:30-16:30', '440304', '深圳市福田区民政局婚姻登记处',
                '黄家林', '445281199304162110', '13760218127',
                '钟佳敏', '440306199612250324', '13169641705',
                33, shijisj)
        input('输入任意字符退出程序')
