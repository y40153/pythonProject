...
def run():
    ...
    if shijisj >= mubiaosj:
        jishiqi.cancel()
        print('时机已到')
        data = seckill('2022-11-11', '11:00-11:30', '440304', '深圳市福田区民政局婚姻登记处',
                       '翁金锋', '441581199507032757', '13640633039',
                       '石春香', '362423199711163043', '15112446836',
                       34)
        while True:
        ...
        seckill('2022-11-11', '10:00-11:00', '440304', '深圳市福田区民政局婚姻登记处',
                '张崴', '500237199208250010', '15002873773',
                '马晶涵', '620502199304260466', '17783323357',
                34)
        seckill('2022-11-11', '10:00-11:00', '440304', '深圳市福田区民政局婚姻登记处',
